...
This is a Tree component extracted from [dndkit](https://github.com/shantanusoam/dnd-dynamic-tree/blob/main/dnd-kit-folder.png?raw=true) examples and abstracted a bit.
